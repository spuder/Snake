...
public class GameEnvironment {
	...
	public static Logger logger = Logger.getLogger(GameEnvironment.class);
	...
	public String activeCubeType;
	
	static model.Game      aGame;
        static view.SnakeGui   theGui;
        static Controller      aController;
                
        public static final GameEnvironment instance = new GameEnvironment();
