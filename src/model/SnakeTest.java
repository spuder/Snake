...
public class SnakeTest {
	...
	/*
	 * Test to verify that an exception is thrown if the constructor 
	 * receives illegal parameters
	 */
	...
	{
		//Create a snake, give it a color, and verify the return is the color expected
	...
	/*
	 * A method to make sure we throw an exception when 
	 * passing in negative values. 
	 * ONLY PUT 1 TEST PER METHOD HERE!
	 */
	@Test(expected=IllegalArgumentException.class)
